...
export const metadata: Metadata = {
  ...
  description:
    "Réservez un appel de 15 minutes pour cadrer votre projet d'études au Québec : lettre d'admission, logement à Montréal, installation et coordination CAQ/permis d'études avec des consultants agréés CICC.",
};
    ...
    <>
      ...
      <main id="main-content">
        <RendezVousProfilePage
          ...
          description="On fait le point sur ta lettre d'admission, ton calendrier, ton logement à Montréal et la coordination de tes démarches étudiantes avec des consultants agréés CICC."
          ...
          benefits={[
            ...
            "Questions Départements Ultramarins, France métropolitaine et familles",
          ]}
          trustBadges={[
            "15 minutes, gratuit, sans engagement",
            "Logement, installation et coordination depuis un seul endroit",
            "Présent pour les étudiants des Départements Ultramarins et de France métropolitaine",
