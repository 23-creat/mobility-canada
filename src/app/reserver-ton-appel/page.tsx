    ...
    <>
      ...
      <main id="main-content" style={{ minHeight: "100vh", background: "var(--mc-white)" }}>
        ...
        <section style={{
          ...
          <div className="mc-container" style={{ position: "relative", zIndex: 2 }}>

            {/* Logo réel */}
            <a href="/" aria-label="Mobility Canada — Accueil" style={{ display: "inline-block", marginBottom: 56 }}>
              <Image
                src="/logo.png"
                alt="Mobility Canada"
                width={80}
            ...
            <div className="mc-reveal" style={{ maxWidth: 740 }}>
        ...
        {/* ── AVIS GOOGLE ── */}
        <section style={{ padding: "48px 0 96px", background: "var(--mc-white)" }} aria-label="Avis de nos clients">
          <div className="mc-container">
      ...
      <footer style={{
        ...
        <div className="mc-container" style={{
          ...
          <a href="/" aria-label="Mobility Canada — Accueil">
